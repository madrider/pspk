...
create table t3
(
region varchar(15) default 'narthamerica' 
)
 alter table  customer 
 add customer_region varchar(15)
 alter table  customer
 add Gender char (1) CHECK (gender in ('M','F')) 

 create table Orders1 
 ( 
 OrdersID Int  IDENTITY (1000,1),
...
alter table Orders
add constraint fk_CustOrders FOREIGN KEY (Customerid) REFERENCES customer(Customerld);
